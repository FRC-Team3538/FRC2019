...
class MotionMagiskRight
{
  public:
    WaypointsR waypointsRight;
    ...
    MotionMagiskRight(TalonSRX &talon) : _talon(talon), _notifer(&MotionMagiskRight::PeriodicTask, this)
    {
        /*
    ...
    void startFilling()
    {
        ...
        startFilling(waypointsRight.kMotionProfile, waypointsRight.kMotionProfileSz);
    }
