...
class MotionMagiskLeft
{
  public:
    WaypointsL waypointsLeft;
    ...
    MotionMagiskLeft(TalonSRX &talon) : _talon(talon), _notifer(&MotionMagiskLeft::PeriodicTask, this)
    {
        /*
    ...
    void startFilling()
    {
        ...
        startFilling(waypointsLeft.kMotionProfile, waypointsLeft.kMotionProfileSz);
    }
